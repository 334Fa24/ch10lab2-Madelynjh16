...
function ans2() {
    heading.style.display = "block";
    answer.textContent = "You cannont tell if an animal has rabies simply by seeing it. A test must be preformed to determine if an animal has rabies. Do not approach wildlife that you suspect might be rabid. Contact us to have the animal removed.";
}
